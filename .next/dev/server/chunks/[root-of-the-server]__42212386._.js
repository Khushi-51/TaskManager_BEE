...
"[project]/task-manager-project (4)/app/api/tasks/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    try {
        ...
        const { status, priority, category, search, view } = Object.fromEntries(new URL(req.url).searchParams);
        let query = {
            userId,
            isTemplate: false
        };
        ...
        const tasks = await __TURBOPACK__imported__module__$5b$project$5d2f$task$2d$manager$2d$project__$28$4$292f$models$2f$Task$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find(query).sort({
            dueDate: 1,
            priority: -1
        }).lean().exec();
        return __TURBOPACK__imported__module__$5b$project$5d2f$task$2d$manager$2d$project__$28$4$292f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(tasks);
    } catch (error) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$task$2d$manager$2d$project__$28$4$292f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
async function POST(req) {
    try {
        ...
        const task = new __TURBOPACK__imported__module__$5b$project$5d2f$task$2d$manager$2d$project__$28$4$292f$models$2f$Task$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"]({
            ...data,
            userId,
            updatedAt: new Date()
        });
        await task.save();
        return __TURBOPACK__imported__module__$5b$project$5d2f$task$2d$manager$2d$project__$28$4$292f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(task, {
            status: 201
        });
    } catch (error) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$task$2d$manager$2d$project__$28$4$292f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__42212386._.js.map