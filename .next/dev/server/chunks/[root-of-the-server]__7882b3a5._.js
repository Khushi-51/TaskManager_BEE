...
async function PUT(req, { params }) {
    try {
        const userId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["verifyToken"])(req);
        if (!userId) {
        ...
        const task = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Task$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findOneAndUpdate({
            _id: params.id,
            userId
        }, {
            ...data,
...
async function DELETE(req, { params }) {
    try {
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mongodb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["connectDB"])();
        const task = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Task$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findOneAndDelete({
            _id: params.id,
            userId
        });
        if (!task) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7882b3a5._.js.map