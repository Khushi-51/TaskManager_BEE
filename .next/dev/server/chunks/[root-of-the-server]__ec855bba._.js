...
async function GET(req) {
    try {
        ...
        const tasks = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Task$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find(query).sort({
            dueDate: 1,
            priority: -1
        }).lean().exec();
...
async function POST(req) {
    try {
        ...
        const task = new __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Task$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"]({
            ...data,
            userId,
            updatedAt: new Date()
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ec855bba._.js.map